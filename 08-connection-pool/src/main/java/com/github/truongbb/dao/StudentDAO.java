...
public class StudentDAO {
  ...
  // vì vậy nên ta nên sử dụng sql, nhưng mà Student phải có đầy đủ id, name, ... mà ta lại không muốn tạo object mới ta sử dụng addScalar của hibernate, tạo nativeSQL
  ...
  // chú ý, tên của thuộc tính lấy ra phải trùng với tên thuộc tính của bean class (ví dụ trên kia là "fullName") và kiểu trả về phải khớp, ví dụ trên kia là StringType
  // cuối cùng là phải transform đúng kiểu của class trả về có thể addScalar cho 1 hoặc nhiều hoặc tất cả thuộc tính của một bean class
