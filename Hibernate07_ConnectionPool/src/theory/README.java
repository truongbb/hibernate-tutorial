...
public class README {
	 ...
	 * 
	 * 
	 * Connection pooling là một kĩ thuật để mở, đóng, chuẩn bị kết nối. Kĩ thuật thùng kết nối này
	 * là một trong những ưu điểm của hibernate khi so sánh với JDBC
	 * 
	 * Khi ta muốn truy vấn, hay thêm, cập nhật, xóa và phải thực hiện connect tới DB,
	 * thì JDBC sẽ mở kết nối, thực hiện thao tác cần thiết và đóng kết nối, cứ vậy cho những lần thực hiện sau
	 ...
	 * với JDBC, bạn mở ra, lấy, đóng vào, và thằng đằng sau xếp hàng cần đồ trong tủ và cũng làm như vậy
	 ...
	 * 
	 * cấu hình trong file hibernate.cfg.xml
	 * 
	 * 
